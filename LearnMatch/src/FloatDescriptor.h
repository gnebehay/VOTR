...
#ifndef FLOAT_DESCRIPTOR_H
#define FLOAT_DESCRIPTOR_H
...
public:
	FloatDescriptor();
	explicit FloatDescriptor(const unsigned char* p);

	inline const Eigen::VectorXd& AsVector() const { return m_data; }
